...
TRACK = pygame.image.load(r"C:\Users\visha\pythonProject4\Scripts\Assets\track.png")


class Car(pygame.sprite.Sprite): #Properties of Car
    def __init__(self):
        super().__init__()
        self.original_image = pygame.image.load(r"C:\Users\visha\pythonProject4\Scripts\Assets\car.png")
    ...
    def collision(self):
        ...
        if SCREEN.get_at(collision_point_right) == pygame.Color(2, 105, 31, 255) \
                or SCREEN.get_at(collision_point_left) == pygame.Color(2, 105, 31, 255): #Touch with Lane
            self.alive = False
    ...
    def radar(self, radar_angle): #LiDAR sensor
        ...
        while not SCREEN.get_at((x, y)) == pygame.Color(2, 105, 31, 255) and length < 200: #Max range is 200
            length += 1
...
if __name__ == '__main__':
    ...
    config_path = r"C:\Users\visha\pythonProject4\Scripts\config.txt"
    run(config_path)